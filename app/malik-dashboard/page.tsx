            ...
            <>
                ...
                <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="flex-1 p-5">
                    ...
                    <div className="flex gap-6 flex-wrap">
                      <div>
                        <p className="text-xs text-gray-400 mb-1.5">Proje Durumu</p>
                        <span className="inline-block bg-blue-50 text-blue-600 text-xs font-semibold px-3 py-1.5 rounded-lg">Devam Ediyor</span>
                      </div>
                      <div>
                        <p className="text-xs text-gray-400 mb-1.5">Blok</p>
                        <p className="text-sm font-bold text-[#0A1F44]">{MALIK.block} Blok</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-400 mb-1.5">Kat</p>
                        <p className="text-sm font-bold text-[#0A1F44]">{MALIK.floor}. Kat</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-400 mb-1.5">Daire No</p>
                        <p className="text-sm font-bold text-[#0A1F44]">{MALIK.unitNumber}</p>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-[#0A1F44] border border-gray-200 px-3 py-1.5 rounded-lg transition-colors">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4" strokeLinecap="round" strokeLinejoin="round"/><polyline points="10 17 15 12 10 7" strokeLinecap="round" strokeLinejoin="round"/><line x1="15" y1="12" x2="3" y2="12" strokeLinecap="round"/></svg>
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1 flex flex-col gap-0">
                    {[
                      { icon: '⊞', label: 'Daire Tipi', value: '3+1' },
                      { icon: '↔', label: 'Brüt Alan', value: '135,50 m²' },
                      { icon: '↔', label: 'Net Alan', value: '108,25 m²' },
                      { icon: '₺', label: 'Satış Bedeli', value: '3.750.000 TL' },
                      { icon: '📄', label: 'Tapu Durumu', value: 'Kat İrtifakı' },
                      { icon: '📅', label: 'Teslim Tarihi', value: 'Aralık 2026' },
                    ].map((row, i, arr) => (
                      <div key={row.label} className={`flex items-center gap-3 py-3 ${i < arr.length - 1 ? 'border-b border-gray-50' : ''}`}>
                        <div className="w-8 h-8 bg-gray-50 rounded-lg flex items-center justify-center flex-shrink-0">
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6B7280" strokeWidth="2">
                            {i === 0 && <><rect x="3" y="3" width="7" height="7" strokeLinecap="round"/><rect x="14" y="3" width="7" height="7" strokeLinecap="round"/><rect x="3" y="14" width="7" height="7" strokeLinecap="round"/><rect x="14" y="14" width="7" height="7" strokeLinecap="round"/></>}
                            {i === 1 && <><path d="M21 6H3" strokeLinecap="round"/><path d="M21 12H3" strokeLinecap="round"/><path d="M21 18H3" strokeLinecap="round"/></>}
                            {i === 2 && <><path d="M21 6H3" strokeLinecap="round"/><path d="M21 12H3" strokeLinecap="round"/><path d="M21 18H3" strokeLinecap="round"/></>}
                            {i === 3 && <><line x1="12" y1="1" x2="12" y2="23" strokeLinecap="round"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" strokeLinecap="round"/></>}
                            {i === 4 && <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round"/><polyline points="14 2 14 8 20 8" strokeLinecap="round"/></>}
                            {i === 5 && <><rect x="3" y="4" width="18" height="18" rx="2" strokeLinecap="round"/><line x1="16" y1="2" x2="16" y2="6" strokeLinecap="round"/><line x1="8" y1="2" x2="8" y2="6" strokeLinecap="round"/><line x1="3" y1="10" x2="21" y2="10" strokeLinecap="round"/></>}
                          </svg>
                        </div>
                  ...
                  {/* Kat planı görseli */}
                  <div className="sm:w-56 h-52 sm:h-auto bg-gray-50 rounded-xl overflow-hidden flex-shrink-0 border border-gray-100">
                    <img
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { label: 'Isıtma Sistemi', value: 'Yerden Isıtma', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#F97316" strokeWidth="2"><path d="M12 2c0 0-4 4-4 8a4 4 0 0 0 8 0c0-4-4-8-4-8z" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 14v4" strokeLinecap="round"/><path d="M8 18h8" strokeLinecap="round"/></svg> },
                    { label: 'Klima Altyapısı', value: 'Var', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth="2"><rect x="2" y="3" width="20" height="8" rx="2" strokeLinecap="round"/><path d="M7 15v2M12 15v2M17 15v2" strokeLinecap="round"/></svg> },
                    { label: 'Balkon', value: 'Var', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" strokeLinecap="round" strokeLinejoin="round"/></svg> },
                    { label: 'Otopark', value: 'Kapalı Otopark', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6366F1" strokeWidth="2"><rect x="1" y="3" width="15" height="13" rx="2" strokeLinecap="round"/><path d="M16 8h4l3 3v5h-7V8z" strokeLinecap="round"/><circle cx="5.5" cy="18.5" r="2.5" strokeLinecap="round"/><circle cx="18.5" cy="18.5" r="2.5" strokeLinecap="round"/></svg> },
                    { label: 'Depo', value: 'Var', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#8B5CF6" strokeWidth="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" strokeLinecap="round"/></svg> },
                    { label: 'Banyo Sayısı', value: '2', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#06B6D4" strokeWidth="2"><path d="M4 12h16a1 1 0 0 1 1 1v3a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4v-3a1 1 0 0 1 1-1z" strokeLinecap="round"/><path d="M6 12V5a2 2 0 0 1 2-2h3v2.25" strokeLinecap="round"/></svg> },
                    { label: 'Ebeveyn Banyosu', value: 'Var', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#EC4899" strokeWidth="2"><circle cx="12" cy="8" r="4" strokeLinecap="round"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" strokeLinecap="round"/></svg> },
                    { label: 'Yön', value: 'Güney - Batı', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2"><circle cx="12" cy="12" r="10" strokeLinecap="round"/><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" strokeLinecap="round"/></svg> },
                  ].map((feat) => (
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    { label: 'Talep / Destek Oluştur', desc: 'Dairenizle ilgili talep oluşturabilirsiniz.', bg: 'bg-green-50', iconBg: 'bg-green-100', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#16A34A" strokeWidth="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" strokeLinecap="round" strokeLinejoin="round"/></svg> },
                    { label: 'Bilgileri Güncelle', desc: 'İletişim ve adres bilgilerinizi güncelleyebilirsiniz.', bg: 'bg-blue-50', iconBg: 'bg-blue-100', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2"><path d="M18 20H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v4" strokeLinecap="round" strokeLinejoin="round"/><path d="M16 2v4M8 2v4M2 10h20" strokeLinecap="round" strokeLinejoin="round"/><path d="m18 14 3 3-3 3" strokeLinecap="round" strokeLinejoin="round"/><path d="M13 17h8" strokeLinecap="round"/></svg> },
                    { label: 'Daire Notlarım', desc: 'Kişisel notlarınızı buradan tutabilirsiniz.', bg: 'bg-orange-50', iconBg: 'bg-orange-100', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#EA580C" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round" strokeLinejoin="round"/><polyline points="14 2 14 8 20 8" strokeLinecap="round" strokeLinejoin="round"/><line x1="16" y1="13" x2="8" y2="13" strokeLinecap="round"/><line x1="16" y1="17" x2="8" y2="17" strokeLinecap="round"/></svg> },
                  ].map((item) => (
                    <button key={item.label} className={`flex items-center gap-3 p-4 ${item.bg} rounded-xl hover:opacity-80 transition-opacity text-left`}>
                      ...
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="2" className="ml-auto flex-shrink-0"><path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    </button>
                  ))}
                </div>
              </div>
              ...
              {activePage === 'anasayfa' && <>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="text-xs text-gray-400 hover:text-[#0A1F44] transition-colors flex items-center gap-1">
                      Tümü <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    </button>
                  </div>
                  <div className="flex flex-col gap-0">
                    {RECENT_PAYMENTS.map((p, i) => (
                      <div key={p.id} className={`flex items-center gap-3 py-3 ${i < RECENT_PAYMENTS.length - 1 ? 'border-b border-gray-50' : ''}`}>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#D1D5DB" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/></svg>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    {TECHNICAL_DOCS.map((doc, i) => (
                      <div key={doc.id} className={`flex items-center gap-3 py-3 ${i < TECHNICAL_DOCS.length - 1 ? 'border-b border-gray-50' : ''}`}>
                        <div className="w-9 h-9 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0">
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#DC2626" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round" strokeLinejoin="round"/><polyline points="14 2 14 8 20 8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                        </div>
                        <div className="flex-1 min-w-0">
                        ...
                        <button className="text-gray-300 hover:text-[#0A1F44] transition-colors">
                          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" strokeLinecap="round" strokeLinejoin="round"/><polyline points="7 10 12 15 17 10" strokeLinecap="round" strokeLinejoin="round"/><line x1="12" y1="15" x2="12" y2="3" strokeLinecap="round"/></svg>
                        </button>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="text-xs text-gray-400 hover:text-[#0A1F44] transition-colors flex items-center gap-1">
                      Detaylı Rapor <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5l7 7-7 7" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    </button>
                  </div>
              ...
              {activePage === 'projelerim' && <>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div>
                      <p className="text-xs text-gray-400 mb-1">Toplam Bedel</p>
                      <p className="text-base font-bold text-[#0A1F44]">3.750.000 TL</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-400 mb-1">Ödenen Tutar</p>
                      <p className="text-base font-bold text-[#22C55E]">1.500.000 TL</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-400 mb-1">Kalan Tutar</p>
                      <p className="text-base font-bold text-[#0A1F44]">2.250.000 TL</p>
                    </div>
                    <div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      { title: 'Satış Sözleşmesi', type: 'PDF' },
                      { title: 'Kat Planı', type: 'PDF' },
                      { title: 'Daire Planı', type: 'PDF' },
                      { title: 'Teknik Şartname', type: 'PDF' },
                    ].map((doc) => (
                      <button key={doc.title} className="flex items-center gap-2.5 p-3 border border-gray-100 rounded-xl hover:border-red-200 hover:bg-red-50/30 transition-all text-left group">
                        <div className="w-8 h-8 bg-red-50 rounded-lg flex items-center justify-center flex-shrink-0">
                          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#DC2626" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" strokeLinecap="round" strokeLinejoin="round"/><polyline points="14 2 14 8 20 8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                        </div>
