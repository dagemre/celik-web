      ...
      <div className="relative bg-white/10 backdrop-blur-sm border-t border-white/15">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/15">
            {[
              { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="2" y="3" width="6" height="18"/><rect x="9" y="8" width="6" height="13"/><rect x="16" y="1" width="6" height="20"/></svg>, value: '16+', label: 'Yıllık Deneyim' },
              { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg>, value: '5000+', label: 'Mutlu Müşteri' },
        ...
        {projects.map((p) => (
          ...
          >
            <div className="relative h-44 overflow-hidden">
              <img src={p.img} alt={p.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" style={{ imageOrientation: 'from-image' }} />
            ...
            <div className="p-4">
              ...
              <div className="flex flex-wrap gap-1 mb-3">
                <span className="flex items-center gap-1 text-[10px] font-semibold text-[#0A1F44] bg-blue-50 border border-blue-100 px-1.5 py-0.5 rounded-md">
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#0A1F44" strokeWidth="2.5"><rect x="2" y="3" width="20" height="4" rx="1"/><rect x="2" y="10" width="20" height="4" rx="1"/><rect x="2" y="17" width="20" height="4" rx="1"/></svg>
                  {p.floors} Kat
                </span>
                <span className="flex items-center gap-1 text-[10px] font-semibold text-[#0A1F44] bg-blue-50 border border-blue-100 px-1.5 py-0.5 rounded-md">
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#0A1F44" strokeWidth="2.5"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                  {p.units} Daire
                </span>
                <span className="flex items-center gap-1 text-[10px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-100 px-1.5 py-0.5 rounded-md">
                  <svg width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="#047857" strokeWidth="2.5"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                  {p.year}
                </span>
              </div>
